...
('Teclado Mecânico Altamente Barulhento', 'Teclado com switches azuis projetado especificamente para irritar todos que moram com você ou trabalham na mesma sala. Iluminação RGB arco-íris que brilha tanto que pode ser vista do espaço sideral.', 450.00, 900.00, 15, 'keyboard', '#7b2cbf', '#ff007f'),
('Mouse Gamer com 12.000 DPI Inúteis', 'Ninguém consegue controlar o cursor nessa velocidade, mas soa bem na caixa. Tem 12 botões laterais que você vai apertar sem querer durante momentos críticos de jogo. Cabo trançado que embaraça sozinho.', 280.00, 560.00, 8, 'mouse', '#00f0ff', '#ffb703');
